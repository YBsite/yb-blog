    ...
    <div class="w-full md:w-1/2 lg:w-1/3 px-2 mb-4">
       ...
       <article class="flex flex-col shadow my-4">
        ...
        <a href="#" class="hover:opacity-75">
            <img class="w-full h-48 object-cover" src="/images/{{$item->image}}">
        </a>
        <div class="bg-white flex flex-col justify-start p-6">
            <a href="#" class="text-blue-700 text-sm font-bold uppercase pb-4">Interview</a>
            ...
            <a href="/interviews/{{$item->slug}}" class="uppercase text-gray-800 hover:text-black">Watch interview<i class="fas fa-arrow-right"></i></a>
        </div>
    </article>
       
    </div>
    @empty
    <p class="pt-5">No interview available.</p>
    @endforelse   
