...
<div class="p-4 flex flex-wrap">
    ...
    <div class="w-full md:w-1/2 lg:w-1/3 px-2 mb-4">
       ...
       <article class="flex flex-col shadow my-4">
        ...
        <a href="#" class="hover:opacity-75">
            <img class="w-full h-48 object-cover" src="/images/{{$item->image_cover}}">
        </a>
        <div class="bg-white flex flex-col justify-start p-6">
            ...
            <a href="/fixtures/{{$item->slug}}" class="uppercase text-gray-800 hover:text-black">Continue Reading <i class="fas fa-arrow-right"></i></a>
        </div>
    ...
    @empty
    <p class="pt-5">No fixture available.</p>
    @endforelse   
